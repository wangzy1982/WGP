...
namespace wgp {
    ...
    public:
        NurbsCurve3dWithoutWeightIntervalCalculator(NurbsCurve3d* nurbs, int index, const Interval& t_domain, bool d0, bool dt, bool dt2) {
            ...
            univariate_polynomial_dt(m_nurbs->m_degree - 1, m_dz_polynomial, m_dz2_polynomial);
            ...
            if (dt || dt2) {
                double dx3_polynomial[g_nurbs_curve3d_polynomial_size];
                double dy3_polynomial[g_nurbs_curve3d_polynomial_size];
                double dz3_polynomial[g_nurbs_curve3d_polynomial_size];
                ...
                univariate_polynomial_dt(m_nurbs->m_degree - 2, m_dz2_polynomial, dz3_polynomial);
                if (dt) {
                ...
                if (dt2) {
                    ...
                    double dx4_polynomial[g_nurbs_curve3d_polynomial_size];
                    ...
                    double dy4_polynomial[g_nurbs_curve3d_polynomial_size];
                    ...
                    double dz4_polynomial[g_nurbs_curve3d_polynomial_size];
                    univariate_polynomial_dt(m_nurbs->m_degree - 3, dz3_polynomial, dz4_polynomial);
    ...
    private:
        ...
        double m_dx2_polynomial[g_nurbs_curve3d_polynomial_size];
        double m_dy2_polynomial[g_nurbs_curve3d_polynomial_size];
        double m_dz2_polynomial[g_nurbs_curve3d_polynomial_size];
    private:
        ...
        double m_xt2_extreme[g_nurbs_curve3d_polynomial_size];
        int m_yt2_extreme_count;
        double m_yt2_extreme[g_nurbs_curve3d_polynomial_size];
        int m_zt2_extreme_count;
        double m_zt2_extreme[g_nurbs_curve3d_polynomial_size];
    };
    ...
    public:
        NurbsCurve3dWithoutWeightIntervalCalculatorByCircleTransformation(NurbsCurve3d* nurbs, int index, const Vector3d& center,
            ...
            double dc2_polynomial[g_nurbs_curve3d_polynomial_size * 2];
            ...
            if (dt) {
                ...
                double dc3_polynomial[g_nurbs_curve3d_polynomial_size * 2];
    ...
    public:
        NurbsCurve3dIntervalCalculator(NurbsCurve3d* nurbs, int index, const Interval& t_domain, bool d0, bool dt, bool dt2) {
            ...
            if (dt || dt2) {
                ...
                if (dt2) {
                    double c_x_polynomial[g_nurbs_curve3d_polynomial_size * 4];
                    double c_y_polynomial[g_nurbs_curve3d_polynomial_size * 4];
                    double c_z_polynomial[g_nurbs_curve3d_polynomial_size * 4];
                    ...
                    double dc_x_polynomial[g_nurbs_curve3d_polynomial_size * 4];
                    double dc_y_polynomial[g_nurbs_curve3d_polynomial_size * 4];
                    double dc_z_polynomial[g_nurbs_curve3d_polynomial_size * 4];
                    ...
                    univariate_polynomial_dt(m_nurbs->m_degree * 4 - 3, c_z_polynomial, dc_z_polynomial);
    ...
    private:
        ...
        double m_dy2_polynomial[g_nurbs_curve3d_polynomial_size];
        double m_dz2_polynomial[g_nurbs_curve3d_polynomial_size];
        double m_dw2_polynomial[g_nurbs_curve3d_polynomial_size];
    private:
        int m_x0_extreme_count;
        double m_x0_extreme[g_nurbs_curve3d_polynomial_size];
        int m_y0_extreme_count;
        ...
        if (m_weights) {
            ...
            if (m_degree == 0) {
                ...
                if (dt || dt2) {
                    ...
                    if (dt2) {
                        double dw2_polynomials[g_nurbs_curve3d_polynomial_size];
                        double dx2_polynomials[g_nurbs_curve3d_polynomial_size];
                        double dy2_polynomials[g_nurbs_curve3d_polynomial_size];
                        double dz2_polynomials[g_nurbs_curve3d_polynomial_size];
                        ...
                        univariate_polynomial_dt(m_degree - 1, dz_polynomials, dz2_polynomials);
