...
namespace wgp {
    ...
    public:
        SketchFeature(Model* model, SceneId id, FeatureSchema* feature_schema, double distance_epsilon);
    ...
    public:
        static bool InitializeSketchModel(Model* model, SceneId sketch_feature_id, double distance_epsilon);
